...
var _user$project$PhotoGroove$initialCmd = A3(
	...
	_evancz$elm_http$Http$getString('http://elm-in-action.com/breakfast-burritos/list'));
			...
			case 'LoadPhotos':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							photos: A2(_elm_lang$core$List$map, _user$project$PhotoGroove$Photo, _p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
